        ...
        <div class="row">
            <!-- form: -->
                <div class="col-lg-8 col-lg-offset-2">
                    ...
                    <form id="updateBookForm" method="post" class="form-horizontal" action="" onsubmit="updateBook(this)" ><!-- action="LoginServlet" -->
                        <input type="hidden" id="bookid" name="bookid" value="<%=bookidStr%>"/>
                        <div class="form-group">
                            <label class="col-lg-3 control-label">bookname:</label>
                            <div class="col-lg-5">
                                <input type="text" id="bookname" class="form-control" name="bookname" value="<%=book.getBookname()%>"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-3 control-label">stock:</label>
                            <div class="col-lg-5">
                                <input type="text" id="stock" class="form-control" name="stock" value="<%=book.getStock() %>" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-3 control-label">price:</label>
                            <div class="col-lg-5">
                                <input type="text" id="price" class="form-control" name="price" value="<%=book.getPrice() %>" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-3 control-label">description:</label>
                            <div class="col-lg-5">
                                <input type="text" id="description" class="form-control" name="description" value="<%=book.getDescription() %>" />
                            </div>
                        </div>
                        <div class="form-group">
            ...
            price:{
                validators: {
                    ...
                    regexp: {
                        ...
                        message: 'The stock can only consist of valid double or integer'
                    }
                }
            }
        }
...
function updateBook(form){
	...
	var url="../AddOrUpdateBookServlet?bookid="+bookid+"&bookname="+bookname+"&price="+price+"&stock="+stock+"&description="+description;
	var xmlhttp;
	  ...
	  xmlhttp.onreadystatechange=function()
	  {
	    ...
	    {
		    if(xmlhttp.responseText!="updateBookT"){
