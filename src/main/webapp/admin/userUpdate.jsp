        ...
        <div class="row">
            <!-- form: -->
                <div class="col-lg-8 col-lg-offset-2">
                    ...
                    <form id="updateUserForm" method="post" class="form-horizontal" action="" onsubmit="updateUser(this)" ><!-- action="LoginServlet" -->
...
function updateUser(form){
	...
	var url="../AddOrUpdateUserServlet?userid="+userid+"&username="+username+"&password="+password+"&phone="+phone;
	var xmlhttp;
	  ...
	  xmlhttp.onreadystatechange=function()
	  {
	    ...
	    {
		    if(xmlhttp.responseText!="updateUserT"){
			    alert("Something wrong when update this user!");
			}else{
