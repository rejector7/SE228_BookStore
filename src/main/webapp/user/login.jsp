...
<body>
	<s:if test="hasActionErrors()">
	 ...
	 <s:if test="hasActionMessages()">
        <script> alert("Register Succeed"); </script>
    </s:if>
	<div class="container">
	   <div class="jumbotron">
	        <h1>用户登录</h1>
        ...
        <div class="row">
            <!-- form: -->
                ...
                <div class="col-lg-8 col-lg-offset-2">
                    ...
                    <form id="loginForm" method="post" class="form-horizontal" action="userLoginAction" ><!-- onsubmit="loginSubmit(this)"--> <!-- action="LoginServlet" -->
                        ...
                        <div class="form-group">
                            <div class="col-lg-9 col-lg-offset-3">
                                ...
                                <a  href="register.jsp"><button type="button" class="btn btn-info">Register</button></a>
                            </div>
                        </div>
                    </form>
                </div>
